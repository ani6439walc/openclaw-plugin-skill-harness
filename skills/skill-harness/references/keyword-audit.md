...
It does **not** analyze intent `keywords`. For those, use design or inventory mode and require labeled positive and collision fixtures under `references/format.md`.
...
| Update intent `keywords` directly from this report | Intent keywords need Step 1 BM25 retrieval evidence    | Use design/inventory labeled fixtures                      |
