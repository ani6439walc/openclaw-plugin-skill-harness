...
| Stats or skill recommendation accounting               | `src/stats/aggregator.ts`, `src/skills/indexer.ts`                                                                         | `src/stats/aggregator.test.ts`, `src/intents/skill-references.test.ts`, README stats docs                      | `pnpm run typecheck`, `pnpm run test`                                                             |
