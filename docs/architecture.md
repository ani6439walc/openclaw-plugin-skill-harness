...
7. Inject selected intent metadata, one routing-guidance sentence, direct matched-intent skill candidates, and immediate candidate-scoped experience metadata.
