...
| `routing.skillCandidates.search.enabled`             | `true`                         | Enables prompt-build direct retrieval; it does not change `skill_search` results.                                                                                                                                                                                                                                         |
| `routing.skillCandidates.search.minCandidateScore`   | `0.6`                          | Inclusive semantic-evidence threshold for entering the pool; it never uses RRF rank score.                                                                                                                                                                                                                                |
| `routing.skillCandidates.search.timeoutMs`           | `2000`                         | Millisecond bound for retrieval and query expansion.                                                                                                                                                                                                                                                                      |
| `routing.skillCandidates.nameMatch.enabled`          | `true`                         | Enables deterministic skill-name matching from the latest request.                                                                                                                                                                                                                                                        |
...
| `routing.skillCandidates.maxPoolSize`                | `12`                           | Maximum candidates retained before injection filtering.                                                                                                                                                                                                                                                                   |
| `routing.skillCandidates.maxInjectedSkills`          | `4`                            | Maximum advisory input-matched skills injected into context.                                                                                                                                                                                                                                                              |
| `routing.skillCandidates.minInjectionScore`          | `0.3`                          | Inclusive score required to inject a pool candidate.                                                                                                                                                                                                                                                                      |
